...
public:
	...
	bool (*IntersectSegment)(/*const CAIntersectQuery& IQuery, CAIntersectInfo* pInfo*/const IntersectQuery& IQuery, IntersectInfo* pInfo);	//0x0064
...
public:
	...
	virtual void SetObjectPos(int* hObj, D3DXVECTOR3* vPos, float fUnk);	//0x00C4
